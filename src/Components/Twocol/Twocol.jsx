        ...
        <div className="flex flex-wrap items-end">
          ...
          <div className="md:basis-1/2">
            <div className="s2-data pb-20 pl-8">
              <h3 className="s2-data-heading">Goal Setting!</h3>
              <p className="mb-8 s2-data-para">
                <ul>
                  <li>
                    1. Goal setting - First step is setting a goal with crystal
                    clarity exactly what you want with exact measurement like
                    60kg weight, 50k salary exact unit should be specified.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      difficulty of workouts helps prevent plateaus and promotes
